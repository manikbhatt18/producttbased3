...
import img1 from "../../images/d17a.png";
import img2 from "../../images/d17b.png";
import img3 from "../../images/d17c.png";

import related1 from "../../images/d1a.png";
      ...
      <div className="container py-5">
        <div className="row">
         ...
         <div className="col-lg-6 product-detail-right">
            ...
            <h1 className="tw-text-3xl tw-font-semibold"> Ultrasonic BTU Energy Meter</h1>
...
Accurate heat & energy metering with zero pressure drop.</li>
              <li className="mb-2 list-item-with-icon"> {/* Added a helper class for consistent styling */}
                <span> 
                  <img 
                    src={arrowIcon} 
...
Smart, maintenance-free BTU measurement for every system.</li>
<li className="mb-2 list-item-with-icon"> {/* Added a helper class for consistent styling */}
                <span> 
                  <img 
                    src={arrowIcon} 
...
Seamless billing-grade metering for heating & cooling networks.</li>
...
<li><b>Commercial HVAC</b> in offices, malls, hotels & hospitals, facilitating <b>smart energy monitoring.</b></li>
<li><b>Industrial process heating & chilled water networks</b> in factories and data centers.</li>
<li><b>Residential multi-unit buildings</b>, for apartment-wise BTU sub-metering.</li>
<li><b>Energy management in green buildings</b>, supporting compliance with sustainability and energy regulations.</li>
<li><b>Retrofit projects and upgrades</b>, where clamp-on design preserves operational continuity.</li>
</ul>
...
<li>FAUN electronic calculator integration—provides BTU, kWh, GJ, MWh calculations with dual tariff and extensive logging capability.</li>
