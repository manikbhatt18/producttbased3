      ...
      <div className="container py-5">
        <div className="row">
         ...
         <div className="col-lg-6 product-detail-right">
            <p className="text-muted">Gas Flow Meter</p>
            <h1 className="tw-text-3xl tw-font-semibold"> GasPro RPD Gas Meter </h1>
...
IOTAFLOW GasPro RPD gas meter for PNG, LPG, biogas in CGD & industries.</li>
              <li className="mb-2 list-item-with-icon"> {/* Added a helper class for consistent styling */}
                <span> 
                  <img 
                    src={arrowIcon} 
...
DN25–DN200, 1600 m³/h. MID, ATEX, CGWA, RS485, EVC & Modbus ready.</li>
              <li className="mb-2 list-item-with-icon"> {/* Added a helper class for consistent styling */}
                <span> 
                  <img 
                    src={arrowIcon} 
