...
import img1 from "../../images/OGM (1).png";
import img2 from "../../images/OGM (2).png";
import img3 from "../../images/OGM (3).png";



import related1 from "../../images/d11a.png";
import related2 from "../../images/d13a.png";
import related3 from "../../images/d24a.png";
import related4 from "../../images/d25a.png";
      ...
      <div className="container py-5">
        <div className="row">
         ...
         <div className="col-lg-6 product-detail-right">
            ...
            <h1 className="tw-text-3xl tw-font-semibold">Oval Gear Oil Flow Meter (OGM)</h1>
