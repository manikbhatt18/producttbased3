      ...
      <div className="container py-5">
        <div className="row">
          ...
          <div className="col-lg-6 mt-5 mt-lg-0">
            ...
            <h3 className="fw-semibold">Inline Vortex flow meters</h3>
...
<ul>
          ...
          {activeTab === "Technical data" && (
           <ul>
  <li>Pipe Range: DN20 – DN800</li>
  <li>Accuracy: ±1% FS (±0.5% FS optional)</li>
  <li>Fluid Temperature: &lt; 250°C (High temp &lt; 350°C optional)</li>
  <li>Operating Pressure: Up to 16 Bar (40 Bar on request)</li>
  <li>Temperature & Pressure Compensation: Built-in (optional)</li>
  ...
  <li>Measurable Fluids:
    <ul>
      ...
      <li>Air</li>
      <li>Liquids</li>
      <li>Other aggressive gases</li>
    </ul>
  </li>
  <li>Certifications: IBR Approved</li>
</ul>
          )}
