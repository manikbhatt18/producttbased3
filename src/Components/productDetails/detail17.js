      ...
      <div className="container py-5">
        <div className="row">
          ...
          <div className="col-lg-6 mt-5 mt-lg-0">
            ...
            <h3 className="fw-semibold">Inline Vortex flow meter</h3>
      ...
      <div className="container">
        <div ref={tabContentRef} className="p-4 border shadow-sm bg-white fade-in">
          ...
          {activeTab === "Technical data" && (
            <ul>
  <li><strong>Pipe Range:</strong> DN20 to DN800</li>
  <li><strong>Accuracy:</strong> ±1% FS (optional ±0.5% FS)</li>
  <li><strong>Fluid Temperature:</strong> &lt;250°C (optional high-temp version &lt;350°C)</li>
  <li><strong>Operating Pressure:</strong> Up to 16 Bar (optional up to 40 Bar)</li>
  <li><strong>Compensation Features:</strong> Built-in temperature and pressure compensation (optional)</li>
  <li><strong>Power Supply:</strong> External 24VDC ±10%</li>
  <li><strong>Output Interfaces:</strong> 4–20mA, RS485, HART (on request)</li>
  <li><strong>Display Protection Ratings:</strong> IP65, IP68, Flameproof (CMRI certified; optional)</li>
  <li><strong>Measurable Fluids:</strong> Steam, Air, Liquids, and other aggressive gases</li>
  <li><strong>Certifications:</strong> IBR Approved</li>
</ul>
          )}
          {activeTab === "Downloads" && (
