       ...
       <div className="container">
         <div ref={tabContentRef} className="p-4 border shadow-sm bg-white fade-in">
           ...
           {activeTab === "Technical data" && (
             <ul>
  <li><strong>Pipe Range:</strong> DN350 to DN2000</li>
  <li><strong>Compensation Features:</strong> Built-in temperature and pressure compensation (optional with insertion mechanism for uninterrupted maintenance)</li>
  <li><strong>Power Supply:</strong> 24VDC ±10%</li>
  <li><strong>Operating Pressure:</strong> Up to 16 Bar</li>
  <li><strong>Output Interfaces:</strong> Pulse, 4–20 mA, RS485, HART (available on request)</li>
  <li><strong>Display Protection Ratings:</strong> IP65, IP68, Flameproof (CMRI certified; available on request)</li>
