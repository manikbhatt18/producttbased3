...
<ul>
  ...
  <li>Mounting Type: In-line / Panel mounted with needle valve</li>
  <li>End Connection:
    <ul>
      <li>Screwed</li>
      <li>Flanged</li>
  ...
  <li>Operating Temperature: Up to 70°C</li>
  <li>Operating Pressure: 10 Bar</li>
  <li>Mounting Accuracy: Bottom to top orientation with ±2% on full scale deflection</li>
  <li>Measuring Tube Float Scale: Laser-engraved on body</li>
</ul>
          )}
