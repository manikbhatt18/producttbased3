...
import img1 from '../../images/Acrylic Rotameter enhanced (1).png';
import img2 from '../../images/Acrylic Rotameter enhanced (2).png';
import img3 from '../../images/Acrylic Rotameter enhanced (3).png';
...
import related4 from '../../images/MTFM (1) edit.png';
    ...
    if (tabContentRef.current) {
      ...
      tabContentRef.current.classList.add('fade-in');
        ...
        const relatedProducts = [
                 ...
                 { img: related4, title: "Metal tube Rotameters (Variable Area measurement) ", link: "/product-detail/detail24" },
      ...
      <div className="container">
        <div ref={tabContentRef} className="p-4 border shadow-sm bg-white fade-in">
          ...
          {activeTab === "Technical data" && (
            <ul>
  <li><strong>Pipe Range:</strong> DN6 to DN100</li>
  <li><strong>Float Material:</strong> PTFE or SS316</li>
  <li><strong>Compatible Media:</strong> Air, Water, Oil, Gas, and Solvents</li>
  <li><strong>Mounting Configuration:</strong> In-line or panel-mounted with integrated needle valve</li>
  <li><strong>End Connections:</strong> Screwed or flanged</li>
  <li><strong>Operating Temperature:</strong> Up to 70°C</li>
  <li><strong>Operating Pressure:</strong> Up to 10 Bar</li>
  <li><strong>Mounting Accuracy:</strong> Bottom-to-top orientation with ±2% Full Scale Deflection (FSD)</li>
  <li><strong>Measurement Scale:</strong> Laser-engraved directly on measuring tube body</li>
  <li><strong>Connection Flange Options:</strong> Polypropylene (PP), Mild Steel (MS), SS304, SS316</li>
</ul>
          )}
          {activeTab === "Downloads" && (
