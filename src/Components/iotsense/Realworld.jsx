  ...
  return (
    <div className="tw-bg-white tw-py-16 sm:tw-py-24">
      <div className="tw-container tw-mx-auto tw-px-4">
        ...
        <div className="tw-max-w-5xl tw-mx-auto tw-flex tw-items-stretch">
          ...
          <div className="tw-py-2">
            ...
            <div className="tw-mt-8">
              <a 
                ...
                className="tw-inline-flex tw-items-center tw-justify-center tw-px-8 tw-py-3 tw-text-base tw-font-bold tw-text-black tw-bg-[#ffd700] tw-rounded-lg tw-shadow-md tw-transition-all tw-duration-300 hover:tw-bg-yellow-400 hover:tw-shadow-lg hover:-tw-translate-y-1 text-decoration-none"
              >
                Learn More
              </a>
            </div>
